...
async def create_job(
    ...
    outline_line: bool = Form(True),
    outline_roi: bool = Form(True),
    outline_bbox: bool = Form(True),
    ...
    roi_panel_cell_w: int = Form(130),
    roi_panel_cell_h: int = Form(78),
    zone_follow_status_color: bool = Form(False),
    occupied_persistence_sec: float = Form(0.0),
    text_scale_mult: float = Form(1.0),
    text_mult_det: float = Form(1.0),
    text_mult_zones: float = Form(1.0),
    text_mult_panels: float = Form(1.0),
    ...
    bbox_fill: bool = Form(False),
    bbox_fill_alpha: float = Form(0.15),
    ...
    cfg = StreamConfig(
        ...
        smooth_bbox=smooth_bbox, smooth_factor=smooth_factor,
        show_rate=show_rate,
        ...
        outline_line=outline_line, outline_roi=outline_roi, outline_bbox=outline_bbox,
        ...
        roi_panel_cell_w=max(40, roi_panel_cell_w),
        roi_panel_cell_h=max(30, roi_panel_cell_h),
        zone_follow_status_color=zone_follow_status_color,
        occupied_persistence_sec=max(0.0, occupied_persistence_sec),
        text_scale_mult=max(0.2, min(5.0, text_scale_mult)),
        text_mult_det=max(0.2, min(5.0, text_mult_det)),
        text_mult_zones=max(0.2, min(5.0, text_mult_zones)),
        text_mult_panels=max(0.2, min(5.0, text_mult_panels)),
        ...
        show_mask=show_mask,
        bbox_fill=bbox_fill,
        bbox_fill_alpha=max(0.0, min(1.0, bbox_fill_alpha)),
        mask_alpha=max(0.0, min(1.0, mask_alpha)),
